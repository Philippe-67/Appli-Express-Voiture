...
using Appli_Express_Voiture.Data;
...
namespace Appli_Express_Voiture.Controllers
{
    public class ReparationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeIntervention,CoutIntervention,VoitureId")] Reparation reparation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeIntervention,CoutIntervention,VoitureId")] Reparation reparation)
        {
            if (id != reparation.Id)
            {
                return NotFound();
